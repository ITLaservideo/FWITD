...
[string]$ListOfDirectories  = Join-Path $ScriptDir "..\..\Resources\Raw\ui\App\utils"
...
Write-Host "- Reading JS files from: '..\..\Resources\Raw\ui\App\utils'"
...
$pattern = 'internal\s+enum\s+utils\s*\{[^}]*\}'
$replacement = "internal enum utils { $enumValues }"
